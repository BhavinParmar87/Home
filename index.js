...
function email() {
    window.open("mailto:bhavinparmar8833@gmail.com", '_parent');
}
function facebook() {
    window.open("https://www.facebook.com/parmar.bahvin?mibextid=ZbWKwL", '_parent');
}
function instagram() {
    window.open("https://www.instagram.com/bhavin._7?igsh=N2ZuYXRjbDFxNG50", '_parent');
}
function linkedin() {
    window.open("https://www.linkedin.com/in/bhavin-parmar-4ba139252?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app", '_parent');
}
function parmarlocation(){
    window.open("https://maps.app.goo.gl/UcXo1EskQoCCWAEaA");
}
